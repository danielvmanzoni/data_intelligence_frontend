  ...
  return (
    <input
      ...
      className={cn(
        ...
        error
          ? "border-red-500 focus:border-red-500 focus-visible:border-red-500 focus:ring-red-500/50 focus-visible:ring-red-500/50"
          : "focus:border-red-500 focus-visible:border-red-500 focus:ring-red-500/50 focus-visible:ring-red-500/50",
        className
      )}
      {...props}
    />
